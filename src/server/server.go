...
func setRoutes() http.Handler {
	...
	handleFunc(r, "/api/v1/lighting/assignment", http.MethodPut, putLightingAssignmentV1)
	handleFunc(r, "/api/v1/lighting/ownership", http.MethodPut, putLightingOwnershipV1)
